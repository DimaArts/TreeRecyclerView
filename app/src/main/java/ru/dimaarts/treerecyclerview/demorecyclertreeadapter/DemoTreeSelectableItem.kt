...
class DemoTreeSelectableItem(id: Int?, text: String, subItems: List<RecyclerTreeViewItem> = listOf(), expanded: Boolean = false): DemoTreeCategoryItem(id, text, subItems, expanded) {
