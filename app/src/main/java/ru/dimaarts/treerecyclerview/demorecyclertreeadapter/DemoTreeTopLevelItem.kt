...
class DemoTreeTopLevelItem(id: Int?, text: String, subItems: List<RecyclerTreeViewItem> = listOf(), level: Int, expanded: Boolean = false): DemoTreeCategoryItem(id, text, subItems, expanded, level), ItemWithId {
